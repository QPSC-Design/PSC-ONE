...
static inline void sa_read_result_matrix(uint16_t out[4])
{
    volatile uint32_t* const RESULT_REG[4] = {
        ...
        reinterpret_cast<volatile uint32_t*>(SA_BASE_ADDR_C + 0x04u),
        reinterpret_cast<volatile uint32_t*>(SA_BASE_ADDR_C + 0x08u),
        reinterpret_cast<volatile uint32_t*>(SA_BASE_ADDR_C + 0x0Cu)
    };
...
static inline void sa_write_A(const uint8_t A_mat[2][2])
{
    volatile uint32_t* const REG_A[2] = {
        reinterpret_cast<volatile uint32_t*>(SA_BASE_ADDR_A),
        reinterpret_cast<volatile uint32_t*>(SA_BASE_ADDR_A + 4u)
    };
...
static inline void sa_write_B(const uint8_t B_mat[2][2])
{
    volatile uint32_t* const REG_B[2] = {
        reinterpret_cast<volatile uint32_t*>(SA_BASE_ADDR_B),
        reinterpret_cast<volatile uint32_t*>(SA_BASE_ADDR_B + 4u)
    };
