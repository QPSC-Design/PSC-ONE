...
static inline bool sp_grows_down(uintptr_t sp_before) {
    volatile uint32_t dummy_local = 0x1234; (void)dummy_local;
    uintptr_t sp_after = read_sp();
    return sp_after < sp_before;  // 下に伸びるなら小さくなる
}
