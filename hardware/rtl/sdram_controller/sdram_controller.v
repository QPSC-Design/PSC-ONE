...
module sdram_controller #(
    ...
    */
    ...
    reg [ROW_ADDR_BUS_WIDTH-1:0] init_adr_r, adr_r;
    reg [BNK_ADDR_BUS_WIDTH-1:0] init_ba_r, ba_r;
    ...
    always @(posedge clock or negedge reset_n) begin
        if (!reset_n) begin
            ...
            init_cas_r      <= 1; 
            init_we_r       <= 1;
            init_adr_r      <= {SD_ADDR_BUS_WIDTH{1'b0}};
            init_ba_r       <= {BNK_ADDR_BUS_WIDTH{1'b0}};
            ...
            case (init_state)
                ...
                1: if (init_cnt_r == 32'd0) begin
                        ...
                        init_cas_r  <= 1; 
                        init_we_r   <= 0; 
                        init_adr_r  <= 11'h400; // PRECHARGE ALL (A10=1)
                ...
                4: if (init_cnt_r == 32'd0) begin
                        ...
                        init_cas_r  <= 0; 
                        init_we_r   <= 0; 
                        init_adr_r  <= 11'h130; // Mode Register Set
