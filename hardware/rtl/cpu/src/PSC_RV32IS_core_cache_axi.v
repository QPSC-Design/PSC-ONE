...
module PSC_RV32IS_core_cache_axi #(
    // Mode 
`ifdef OS_SIM
...
`endif
    ...
    parameter integer DATA_WIDTH   = 16,    // AXI bus. fixed 16
    ...
    */
    ...
    // ---------------- Bridge (AXI Master, 16-bit) ----------------
    sdram_16bit_to_128bit_axi_bridge #(
