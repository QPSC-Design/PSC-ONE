...
// for the part.
`define GW2AR_SDRAM   // 8MB part
//`define MT48LC32M16   // 64MB part
//`define MT48LC16M16   // 32MB part
//`define MT48LC4M16    //  8MB part

//module mt48lc16m16a2 (Dq, Addr, Ba, Clk, Cke, Cs_n, Ras_n, Cas_n, We_n, Dqm);
module GW2AR_sdram (Dq, Addr, Ba, Clk, Cke, Cs_n, Ras_n, Cas_n, We_n, Dqm);

`ifdef GW2AR_SDRAM
   // Params. for  GW2AR_SDRAM (8MB part)
...
`endif
   ...
   parameter data_bits =      32;       // GW2AR: 32bit data bus
