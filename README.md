...
PSC-ONE integrates a custom CPU, memory subsystem, peripherals, operating system, and AI accelerator into a unified architecture, enabling end-to-end hardware/software co-design.  
The SynapEngine AI accelerator is tightly integrated with the CPU through a shared memory hierarchy, eliminating explicit data transfers and improving efficiency for matrix operations, signal processing, and neural network inference workloads.  
...
Both the PSC_RV32ISP core and the SynapEngine share the same L1 cache, forming a unified low-latency memory space.  
Unlike loosely coupled accelerator designs that rely on DMA transfers, this approach allows direct data sharing and eliminates redundant memory copies.  
...
| Subtractors      | 2                    | 3        |
| Multipliers      | **0**                | **0**    |
| Multiplexers     | 359                  | 148      |
| Comparators      | 305                  | 69       |
| Registers (FF)   | 182                  | 105      |
...
<img src="hardware/rtl/ai/docs/images/PSC_SynapEngine.jpg" width="800">
...
- 2×2 int8 systolic array
- Weight-Stationary (WS) mode
- Output-Stationary (OS) mode
- Memory-mapped accelerator control
- Custom RISC-V integration
- Experimental hardware/software co-design platform

---

## PSC-ONE AI vs PicoRV32 (Yosys Analysis)
...
[![Watch the demo](https://img.youtube.com/vi/FILxQiaqKrk/maxresdefault.jpg?utm_source=chatgpt.com)](https://youtu.be/FILxQiaqKrk?si=9KQKO3LVkketo0ZM)
...
- [x] Pipeline Architecture (PSC_RV32ISP)
...
Currently manufacturing a demonstration FPGA board.  
Implementing speech recognition and robotic control using the AI accelerator.
